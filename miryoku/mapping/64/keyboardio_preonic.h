...
#if !defined (MIRYOKU_LAYOUTMAPPING_KEYBOARDIO_PREONIC)

#define XXX &none

#if defined MIRYOKU_MAPPING_EXTENDED_THUMBS
#define MIRYOKU_LAYOUTMAPPING_KEYBOARDIO_PREONIC(\
...
#define MIRYOKU_MAPPING MIRYOKU_LAYOUTMAPPING_KEYBOARDIO_PREONIC
